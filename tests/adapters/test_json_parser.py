...
class TestJsonParser:
    ...
    def test_validate_invalid_priority(self, parser: JsonParser) -> None:
        ...
        content = json.dumps({
            "stories": [
                {"id": "US-001", "title": "Test", "priority": "invalid"}
            ]
        })
    ...
    def test_validate_invalid_status(self, parser: JsonParser) -> None:
        ...
        content = json.dumps({
            "stories": [
                {"id": "US-001", "title": "Test", "status": "invalid"}
            ]
        })
            ...
            "stories": [
                {
                    ...
                    "title": "Test",
                    "commits": [
                        {"hash": "abc123def456", "message": "Fix bug"},
                        "deadbeef"
                    ]
                }
            ]
