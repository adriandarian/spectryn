...
# Homebrew formula for md2jira
# To install from local tap:
#   brew tap adriandarian/md2jira https://github.com/adriandarian/homebrew-md2jira
...
class Md2jira < Formula
  ...
  homepage "https://github.com/adriandarian/md2jira"
  url "https://github.com/adriandarian/md2jira/archive/refs/tags/v2.0.0.tar.gz"
  sha256 "PLACEHOLDER_SHA256_HASH"
  license "MIT"
  head "https://github.com/adriandarian/md2jira.git", branch: "main"
  ...
  def install
    ...
    generate_completions_from_executable(bin/"md2jira", "--completions")
  end

  def caveats
    <<~EOS
      To use md2jira, set these environment variables:
        export JIRA_URL="https://your-company.atlassian.net"
        export JIRA_EMAIL="your.email@company.com"
        export JIRA_API_TOKEN="your-api-token"

      Or create a config file at ~/.md2jira.yaml
  ...
  test do
    assert_match "md2jira", shell_output("#{bin}/md2jira --version")
    assert_match "usage:", shell_output("#{bin}/md2jira --help")
  end
end
