"""
Testing Utilities for md2jira.

Provides pytest fixtures and helpers for testing with dependency injection.

Usage in tests:
    from md2jira.testing import container_fixture, mock_tracker
...
Or import fixtures directly in conftest.py:
    from md2jira.testing import container_fixture
"""
...
def pytest_plugin_fixtures():
    ...
    Usage in conftest.py:
        from md2jira.testing import pytest_plugin_fixtures
